...
export default function DocumentsPage() {
  return (
    ...
    >
      <div className="stack">
        <SectionHeading
          eyebrow={t("cabinet.nav_documents")}
          title={t("cabinet.nav_documents")}
          subtitle={t("cabinet.sections.documents.desc")}
        />
        <div className="card card--outline">
          <p className="text-muted">{t("cabinet.documents_empty")}</p>
        </div>
      </div>
    </RailLayout>
  );
